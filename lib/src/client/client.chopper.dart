...
class _$CalendarificClient extends CalendarificClient {
  ...
  Future<Response<dynamic>> getHolidaysByType(
      String apiKey, String countryCode, String year, String type) {
    final $url =
  ...
  @override
  Future<Response<dynamic>> getHolidaysByLocationAndType(String apiKey,
      String countryCode, String year, String location, String type) {
    final $url =
  ...
  @override
  Future<Response<dynamic>> getSpecificHolidaysByType(String apiKey,
      String countryCode, String year, int day, int month, String type) {
    final $url =
  ...
  Future<Response<dynamic>> getHolidaysFromMonthByType(
      String apiKey, String countryCode, String year, int month, String type) {
    final $url =
